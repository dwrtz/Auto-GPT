...
class Agent:
    ...
    def start_interaction_loop(self):
        ...
        while True:
            ...
            command_name, arguments, assistant_reply_json = self.get_agent_thoughts(cfg, spinner=True)
            ...
            if not cfg.continuous_mode and self.next_action_count == 0:
                ...
                user_input, human_feedback  = self.get_user_input_from_terminal(cfg, assistant_reply_json)
                command_name = "human_feedback" if human_feedback else command_name
            ...
            result = self.execute_agent_command(cfg, command_name, arguments, user_input)
    ...
    def get_agent_thoughts(self, cfg: Config, spinner=False) -> Tuple[str, str | dict, dict]:
        # Send message to AI, get response
        with Spinner("Thinking... ", enabled=spinner):
    ...
    def get_user_input_from_terminal(
            self, cfg: Config, assistant_reply_json: dict,
        ) -> Tuple[str, bool]:
        logger.info(
        ...
        return user_input, human_feedback

    def execute_agent_command(
            self, cfg: Config, command_name: str, arguments: str | dict, user_input: str,
        ) -> str:
        # Execute command
